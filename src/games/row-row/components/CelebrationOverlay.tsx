...
export default function CelebrationOverlay({
  ...
  // Dismissed = card out of the way so the kid can see the boat at the
  // finish; a floating pill reopens it. Local state keeps the component
    ...
    <div className={styles.overlay} role="dialog">
      <div className={styles.card}>
        <button
          ...
          aria-label="Close results and view the fjord"
        >
          ✕
        </button>
        <h2 className={styles.title}>🚣 You made it across!</h2>
        ...
        <div className={styles.actions}>
          <BigButton onClick={onPlayAgain}>🔄 Next crossing</BigButton>
