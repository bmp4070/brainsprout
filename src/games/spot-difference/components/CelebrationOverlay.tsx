...
export default function CelebrationOverlay({
  ...
  // Collapsed = card out of the way so the kid can admire both fully-circled
  // pictures; a floating pill reopens it. Local state on purpose: the
  // component stays mounted while collapsed, so the one-shot celebration
  // guard below isn't re-triggered on reopen.
  ...
  return (
    <div className={styles.overlay} role="dialog" aria-label="Spot the Difference results">
      <div className={styles.card}>
        <button
          type="button"
          className={styles.closeButton}
          onClick={() => setCollapsed(true)}
          aria-label="Close results and view the circled pictures"
        >
          ✕
        </button>
        ...
        <div className={styles.actions}>
          <BigButton onClick={onNewPicture}>🔄 New picture</BigButton>
