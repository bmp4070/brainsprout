...
import type { MazeResult } from '../lib/scoring';
...
export default function CelebrationOverlay({
  ...
  // Collapsed = card out of the way so the kid can admire the solved maze;
  ...
  return (
    <div className={styles.overlay} role="dialog" aria-label="Maze results">
      <div className={styles.card}>
        <button
          type="button"
          className={styles.closeButton}
          onClick={() => setCollapsed(true)}
          aria-label="Close results and view the solved maze"
        >
          ✕
        </button>
        <h2 className={styles.title}>🧭✨ You made it!</h2>
        ...
        <div className={styles.actions}>
          <BigButton onClick={onNewMaze}>🔄 New maze</BigButton>
