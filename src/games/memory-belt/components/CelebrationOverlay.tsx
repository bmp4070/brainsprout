...
export default function CelebrationOverlay({
  ...
  useEffect(() => {
    ...
    // 1-2 star finishes get a lighter cue -- no confetti.
    playFound();
  }, [result.stars]);

  return (
    <div className={styles.overlay} role="dialog" aria-label="Memory Belt results">
      <div className={styles.card}>
        <h2 className={styles.title}>🧠✨ You caught them all!</h2>
