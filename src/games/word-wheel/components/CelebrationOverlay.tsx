...
export default function CelebrationOverlay({
  ...
  // Collapsed = card out of the way so the kid can admire the filled-in
  // slots; a floating pill reopens it. Local state on purpose: the
  ...
  return (
    <div className={styles.overlay} role="dialog" aria-label="Word Wheel results">
      <div className={styles.card}>
        <button
          type="button"
          className={styles.closeButton}
          onClick={() => setCollapsed(true)}
          aria-label="Close results and view the finished wheel"
        >
          ✕
        </button>
        ...
        <div className={styles.actions}>
          <BigButton onClick={onNewWheel}>🔄 New wheel</BigButton>
